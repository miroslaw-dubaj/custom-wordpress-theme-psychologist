<?php
/**
 * marzenakwasik functions and definitions
 *
...
if ( ! function_exists( 'marzenakwasik_setup' ) ) :
	/**
	 ...
	 */
	function marzenakwasik_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on marzenakwasik, use a find and replace
		 * to change 'marzenakwasik' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'marzenakwasik', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'marzenakwasik' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'marzenakwasik_custom_background_args', array(
...
add_action( 'after_setup_theme', 'marzenakwasik_setup' );
 ...
 */
function marzenakwasik_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'marzenakwasik_content_width', 640 );
}
add_action( 'after_setup_theme', 'marzenakwasik_content_width', 0 );
 ...
 */
function marzenakwasik_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'marzenakwasik' ),
		'id'            => 'sidebar-1',
...
class WPDocs_Walker_Nav_Menu extends Walker_Nav_Menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        // Build HTML.
        $output .= $indent . '<li id="nav-menu-item-'. $item->ID . '" class="' . $depth_class_names . ' ' . $class_names . $is_current_item .'">';
...
add_action( 'wp_enqueue_scripts', 'marzenakwasik_scripts' );
